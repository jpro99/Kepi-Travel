...
const SCAN_SYSTEM_PROMPT = [
  ...
  "Shape:",
  '{ "reservations": [ { "type": "", "title": "", "provider": "", "confirmationCode": "", "localTime": "", "checkOutDate": "", "timezone": "", "location": "", "notes": "", "flightNumber": "", "departureAirport": "", "arrivalAirport": "", "trainNumber": "", "trainPlatform": "", "trainSeat": "", "roomType": "", "cashUsd": 0, "pointsMiles": 0, "pointsProgram": "" } ] }',
  ...
  "For trains (ÖBB, Deutsche Bahn, Trenitalia): type=train, trainNumber (e.g. RJ 86 or EC 88), localTime=departure YYYY-MM-DD HH:mm, location=From → To, trainPlatform when printed (Gleis/binario), trainSeat as coach/seats (e.g. 267/63,64).",
  "ÖBB PDFs often have FAHRSCHEIN (flexible route ticket) plus RESERVIERUNG (specific train, Wagen, Sitzplätze) — merge into one train reservation using the reservation page for train number, departure time, and seats.",
